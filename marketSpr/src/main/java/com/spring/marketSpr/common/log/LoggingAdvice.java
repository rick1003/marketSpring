package com.spring.marketSpr.common.log;
...
public class LoggingAdvice {
	...
	@Before("execution(* com.spring.marketSpr.*.service.*.*(..)) or "
			+ "execution(* com.spring.marketSpr.*.dao.*.*(..))")
	...
	@After("execution(* com.spring.marketSpr.*.service.*.*(..)) or "
			+ "execution(* com.spring.marketSpr.*.*.dao.*.*(..))")
	...
	@Around("execution(* com.spring.marketSpr.*.service.*.*(..)) or "
			+ "execution(* com.spring.marketSpr.*.dao.*.*(..))")
